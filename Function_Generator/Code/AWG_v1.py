...
print("#step through offsets, amp=0.4")
wave1.amplitude=0.4
...
print("#pulse: step through duty cycle")
wave1.amplitude=1.0
wave1.offset=0.0
wave1.func=pulse
...
print("#pulse: step through rise time,fall time")
...
print("#pulse: step from saw to triangle to saw")
...
print("#gaussian: step through widths")
wave1.func=gaussian
...
print("#sinc: step through widths")
wave1.func=sinc
wave1.amplitude=0.5
wave1.offset=0.2
...
print("#exponential: step through widths")
...
print("# reverse exponential: step through widths")
wave1.replicate=-1
for width in (0.20,0.10,0.05,0.02):
    print(width)
    wave1.pars=[width]
...
print("# noise: step through quality")
wave1.replicate=1
wave1.func=noise
wave1.amplitude=0.2
wave1.offset=0.5
...
print("# summation: build up a square wave from sines")
wi={}
for i in range(6):
    print(i)
    wi[i]=wave()
...
print("#summation: exponential + gaussians")
wave1=wave()
wave1.amplitude=0.8
wave1.offset=0.0
wave1.phase=0.0
...
print("# product: sine * exponential")
wave1=wave()
wave1.amplitude=0.4
wave1.offset=0.3
wave1.phase=0.0
...
print("# modulate: sine with sine - small beta")
wave1=wave()
wave1.amplitude=0.5
wave1.offset=0.5
wave1.phase=0.0
...
print("# modulate: sine with sine - large beta")
wave1=wave()
wave1.amplitude=0.5
wave1.offset=0.5
wave1.phase=0.0
...
print("# modulate: pulse with pulse")
wave1=wave()
wave1.amplitude=1.0
wave1.offset=0.0
wave1.phase=0.0
